# Scrapy settings for crawl_cp_tvsi project
#
...
BOT_NAME = 'crawl_cp_tvsi'

SPIDER_MODULES = ['crawl_cp_tvsi.spiders']
NEWSPIDER_MODULE = 'crawl_cp_tvsi.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'crawl_cp_tvsi (+http://www.yourdomain.com)'
...
DOWNLOADER_MIDDLEWARES = {
    ...
    'crawl_cp_tvsi.middlewares.RandomUserAgentMiddleware': 100,
    'crawl_cp_tvsi.middlewares.ProxyMiddleware': 200,
    'crawl_cp_tvsi.middlewares.RetryMiddleware': 820
}

ITEM_PIPELINES = {
    'crawl_cp_tvsi.pipelines.MongoDBPipeline': 1,
}
