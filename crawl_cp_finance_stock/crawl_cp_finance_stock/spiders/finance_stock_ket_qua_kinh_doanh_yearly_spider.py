...
class FinanceStockKetQuaKinhDoanhYearlySpider(CrawlSpider):
    name = "finance_stock_ket_qua_kinh_doanh_yearly"

    def __init__(self, **kwargs):
        super(FinanceStockKetQuaKinhDoanhYearlySpider, self).__init__(**kwargs)
        self.allowed_domains = ['finance.vietstock.vn']

        self.lst_cp =  HOSE + HNX

        self.start_urls = ['https://finance.vietstock.vn']
        settings['CRAWLER_COLLECTION'] = "KET_QUA_KINH_DOANH_YEARLY"
