...
class FinanceStockLuuChuyenTienTeQuarterSpider(CrawlSpider):
    name = "finance_stock_luu_chuyen_tien_te_quarter"

    def __init__(self, **kwargs):
        super(FinanceStockLuuChuyenTienTeQuarterSpider, self).__init__(**kwargs)
        self.allowed_domains = ['finance.vietstock.vn']

        self.lst_cp =  HOSE + HNX

        self.start_urls = ['https://finance.vietstock.vn']
        settings['CRAWLER_COLLECTION'] = "LUU_CHUYEN_TIEN_TE_QUARTER"
