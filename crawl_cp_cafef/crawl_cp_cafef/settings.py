# Scrapy settings for crawl_cp_cafef project
#
...
BOT_NAME = 'crawl_cp_cafef'
ROBOTSTXT_OBEY = True

LOG_LEVEL = 'INFO'
NEWSPIDER_MODULE = 'crawl_cp_cafef.spiders'
ROBOTSTXT_OBEY = True
...
MONGODB_DATABASE = 'CRAWLER_CO_PHIEU_CAFEF'
